package com.example.kousalya.swiggy.retrofit;
...
public class APIGenerator {
    //http://compassites-dev-api.herokuapp.com/apis/news-feed?project=SW
    public static String BASE_URL = "http://compassites-dev-api.herokuapp.com/apis";
    ...
    public static <S> S createService(Class<S> serviceClass) {
        ...
        RestAdapter.Builder builder = new RestAdapter.Builder()
                ...
                .setLog(msg -> Timber.tag("Retro").i(msg))
